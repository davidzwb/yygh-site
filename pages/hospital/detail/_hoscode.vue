<template>
  ...
  <div class="nav-container page-component">
    ...
    <!-- 右侧内容 #start --> <div class="page-container">
      <div class="hospital-detail">
        <div class="common-header">
          <div class="title-wrapper">
            <span class="hospital- title">{{ hospital.hosname }}</span> <div class="icon-wrapper">
              <span class="iconfont" /> {{ hospital.param.hostypeString }}
            </div>
          </div>
          ...
          > <div class="content-wrapper">
            <div /> <div /> <div /> <div>
              <div class="icon-text- wrapper">
                <span class="iconfont prefix-icon" /> <span class="text">
                  <p>{{ hospital.route }}</p> </span><span class="iconfont right-icon" />
              </div>
            </div>
          </div>
        </div> <div class="title mt40">
          医院介绍
        </div> <div class="detail- content mt40">
          <p>{{ hospital.intro }}</p>
        </div>
      </div>
    </div> <!-- 右侧内容 #end -->
